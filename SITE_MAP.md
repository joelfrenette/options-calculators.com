...
**Totals:** 54 API routes · 86 components · 40 lib modules · 41 public tabs across 4 nav groups.
...
| `panic-euphoria` | Citibank's Panic & Euphoria Index | `PanicEuphoria` | `components/panic-euphoria.tsx` | 1156 | `/api/panic-euphoria` |
...
| api.quiverquant.com | `/api/insider-trading`<br>`lib/quiver.ts` |
...
| `components/panic-euphoria.tsx` | 1156 | 556 |
