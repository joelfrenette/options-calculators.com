...
**Totals:** 59 API routes · 131 components · 79 lib modules · 42 public tabs across 4 nav groups.
...
| production.dataviz.cnn.io | `/api/admin/api-status`<br>`/api/ccpi`<br>`/api/market-sentiment`<br>`/api/social-sentiment`<br>`lib/market-sentiment/upstream.ts`<br>`lib/sentiment-sources.ts` |
