...
**Totals:** 61 API routes · 81 components · 53 lib modules · 42 public tabs across 4 nav groups.
...
| `/api/ccpi-signals` | GET | dynamic="force-dynamic"<br>revalidate=0<br>maxDuration=60 | — | — | **no** | `lib/api-contracts.ts`<br>`app/api/admin/run-health-checks/route.ts` |
