...
**Totals:** 61 API routes · 86 components · 54 lib modules · 42 public tabs across 4 nav groups.
...
|---|---|---|---|---|---|
| `ccpi` ★ | Crash & Corrections Prediction Index | `CcpiDashboard` | `components/ccpi-dashboard.tsx` | 1155 | `/api/ccpi/executive-summary`<br>`/api/ccpi`<br>`/api/ccpi/cache`<br>`/api/ccpi/history` |
...
| `components/ccpi-dashboard.tsx` | 1155 | 555 |
