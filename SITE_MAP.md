...
**Totals:** 59 API routes · 81 components · 51 lib modules · 42 public tabs across 4 nav groups.
...
| `social-sentiment` | Social Sentiment Index | `SocialSentiment` | `components/social-sentiment.tsx` | 746 | `/api/social-sentiment` |
...
| `components/social-sentiment.tsx` | 746 | 146 |
