...
> Generated by `node scripts/site-inventory.ts` on 2026-08-12. **Do not hand-edit the
> generated sections** — re-run the script. Sign-off checkboxes in §6 are hand-maintained.

**Totals:** 60 API routes · 83 components · 51 lib modules · 42 public tabs across 4 nav groups.
...
| `components/scanner/use-wheel-scanner.ts` | 602 | 2 |
