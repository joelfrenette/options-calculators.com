...
**Totals:** 65 API routes · 174 components · 104 lib modules · 42 public tabs across 4 nav groups.
...
| Tab id | Label | Component | File | Lines | Internal APIs |
|---|---|---|---|---|---|
| `wheel-scanner` | Sell Put Scanner | `WheelScanner` | `components/wheel-scanner.tsx` | 430 | none (static) |
...
| `butterfly-scanner` | Butterflies | `ButterflyScanner` | `components/butterfly-scanner.tsx` | 580 | `/api/strategy-scanner` |
| `leaps-scanner` | LEAPS | `LEAPSScanner` | `components/leaps-scanner.tsx` | 573 | `/api/strategy-scanner` |
| `zebra-scanner` | ZEBRA | `ZEBRAScanner` | `components/zebra-scanner.tsx` | 543 | `/api/strategy-scanner` |
...
| `components/scanner/use-wheel-scanner.ts` | 640 | 40 |
