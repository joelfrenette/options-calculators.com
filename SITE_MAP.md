...
**Totals:** 62 API routes · 172 components · 94 lib modules · 42 public tabs across 4 nav groups.
...
| `/api/auth/login` | POST | dynamic="force-dynamic" | — | — | yes | `app/login/page.tsx`<br>`components/door-calculator.tsx`<br>`lib/api-contracts.ts`<br>`lib/login-rate-limit.ts`<br>`app/api/admin/run-health-checks/route.ts` |
