...
**Totals:** 59 API routes · 131 components · 74 lib modules · 42 public tabs across 4 nav groups.
...
| app.scrapingbee.com | `/api/admin/api-status`<br>`/api/ccpi`<br>`/api/market-sentiment`<br>`/api/panic-euphoria`<br>`/api/scraping-bee`<br>`/api/scraping-bee/diagnostics`<br>`/api/social-sentiment`<br>`lib/remediation.ts`<br>`lib/scraping-bee.tsx`<br>`lib/sentiment-sources.ts` |
...
| production.dataviz.cnn.io | `/api/admin/api-status`<br>`/api/ccpi`<br>`/api/market-sentiment`<br>`/api/social-sentiment`<br>`lib/sentiment-sources.ts` |
