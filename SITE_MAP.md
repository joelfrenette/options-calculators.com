...
**Totals:** 64 API routes · 174 components · 102 lib modules · 42 public tabs across 4 nav groups.
...
| `/api/report-email` | POST | dynamic="force-dynamic" | — | RESEND_API_KEY | **no** | `components/email-report-button.tsx`<br>`lib/api-contracts.ts`<br>`app/api/admin/run-health-checks/route.ts` |
