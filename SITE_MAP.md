...
**Totals:** 60 API routes · 87 components · 53 lib modules · 42 public tabs across 4 nav groups.
...
|---|---|---|---|---|---|
| `ccpi` ★ | Crash & Corrections Prediction Index | `CcpiDashboard` | `components/ccpi-dashboard.tsx` | 938 | `/api/ccpi/executive-summary`<br>`/api/ccpi`<br>`/api/ccpi/history` |
...
| `components/ccpi-dashboard.tsx` | 938 | 338 |
