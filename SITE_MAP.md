...
**Totals:** 57 API routes · 86 components · 42 lib modules · 41 public tabs across 4 nav groups.
...
| `/api/federal-money` | GET | dynamic="force-dynamic" | — | — | **no** | `lib/api-contracts.ts`<br>`app/api/admin/run-health-checks/route.ts` |
