                ...
                <div className="mb-4 p-4 bg-white rounded-lg border border-blue-200 shadow-sm">
                  <div className="flex items-start gap-3">
                    <button
                      ...
                      className="flex-shrink-0 w-auto px-3 py-1.5 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center gap-1.5 shadow-md hover:from-blue-600 hover:to-indigo-700 transition-all cursor-pointer"
                    >
