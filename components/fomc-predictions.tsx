...
export function FomcPredictions() {
  ...
  return (
    <div className="space-y-4">
      ...
      {chartData.length > 0 && (
        <Card className="shadow-lg border-2 border-primary/20">
          <CardHeader className="bg-primary/5 border-b border-primary/20">
            <CardTitle className="text-lg font-bold text-gray-900">Federal Funds Rate - Forecast Chart</CardTitle>
            <CardDescription>
          ...
          <CardContent className="pt-6">
            ...
            <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-xs text-blue-800">
                ...
                data, sampled monthly). Market consensus forecast calculated from Fed Funds futures and Treasury yields
                for FOMC meetings, with trend extrapolation to 2 years forward. Values represent monthly averages.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      {nextMeeting && (
        <Card className={`shadow-lg border-2 ${getPredictionBg(nextMeeting.prediction)}`}>
          <CardHeader className="border-b border-gray-200">
            <CardTitle className="text-xl font-bold text-gray-900 flex items-center gap-2">
              <Calendar className="h-6 w-6 text-primary" />
              Next FOMC Meeting: {nextMeeting.date}
            </CardTitle>
            <CardDescription className="text-base">{nextMeeting.daysUntil} days until announcement</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="grid md:grid-cols-3 gap-6">
              {/* Prediction */}
              <div className="text-center">
                <div className="flex justify-center mb-2">{getPredictionIcon(nextMeeting.prediction)}</div>
              ...
              <div className="text-center">
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Implied Rate</p>
      ...
      {ratePath && (
        <Card className="shadow-sm border-gray-200">
          <CardHeader className="bg-gray-50 border-b border-gray-200">
            <CardTitle className="text-lg font-bold text-gray-900">Expected Rate Path</CardTitle>
          ...
          <CardContent className="pt-6">
            ...
            <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-xs text-gray-700">
                <span className="font-semibold">Note:</span> Historical rates from FRED data (real). Future projections
                based on market pricing, economic indicators, and FOMC meeting schedule. Predictions may change as
      ...
      {economicIndicators && (
        <Card className="shadow-sm border-gray-200">
          <CardHeader className="bg-gray-50 border-b border-gray-200">
            <CardTitle className="text-lg font-bold text-gray-900">Key Economic Indicators</CardTitle>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 bg-white rounded-lg border-2 border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-semibold text-gray-900">Unemployment Rate</p>
              ...
              <div className="p-4 bg-white rounded-lg border-2 border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-semibold text-gray-900">CPI Inflation</p>
              ...
              <div className="p-4 bg-white rounded-lg border-2 border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-semibold text-gray-900">Core CPI</p>
              ...
              <div className="p-4 bg-white rounded-lg border-2 border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-semibold text-gray-900">PCE Inflation</p>
              ...
              <div className="p-4 bg-white rounded-lg border-2 border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-semibold text-gray-900">GDP Growth</p>
              ...
              <div className="p-4 bg-white rounded-lg border-2 border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-semibold text-gray-900">Non-Farm Payrolls</p>
          ...
          <CardContent className="pt-4">
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                {/* CHANGE> Added color-coded badge for inflation trend */}
                <span
              ...
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                {/* CHANGE> Added color-coded badge for labor trend */}
                <span
              ...
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                {/* CHANGE> Added color-coded badge for growth trend */}
                <span
          ...
          <CardContent className="pt-4">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-200 md:col-span-2">
                ...
                {/* CHANGE> Added color-coded badge for market expectation */}
                <span
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-2">
                  ...
                  <div className="text-sm bg-white p-2 rounded border border-blue-200">
                    <span className="font-semibold text-gray-900">Growth:</span> {predictionMethodology.weights.growth}
                  </div>
                  <div className="text-sm bg-white p-2 rounded border border-blue-200">
