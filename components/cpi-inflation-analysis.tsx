            ...
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-lg font-bold text-gray-900 flex items-center gap-2">
                  ...
                  <InfoTooltip content="CPI (Consumer Price Index) measures the average change in prices paid by consumers for goods and services. Rising CPI signals inflation, which typically leads to Fed rate hikes - bad for growth stocks but can benefit value and commodity sectors." />
                </CardTitle>
                  ...
                  <div className="space-y-3 mt-3">
                    ...
                    <div className="border-l-4 border-yellow-500 pl-3">
                      <p className="font-semibold text-yellow-900">
                        Moderate Inflation Pressure (Target + 0.5% to 1.5%)
                      </p>
                      <ul className="list-disc ml-5 text-gray-700 text-xs space-y-1 mt-1">
        ...
        <Card className="shadow-lg border-2 border-primary/20">
          <CardHeader className="bg-primary/5 border-b border-primary/20">
            <CardTitle className="text-lg font-bold text-gray-900">
              U.S. Inflation (CPI-U) - Forecast Chart
              <InfoTooltip content="This chart shows 2 years of historical CPI data (solid line) and a 2-year forecast (dashed line). For options traders: rising inflation forecasts suggest higher volatility ahead, favoring premium-selling strategies. Falling forecasts support growth stock bullish plays." />
            </CardTitle>
            <CardDescription>
        ...
        <Card className="shadow-lg border-2 border-gray-200">
          <CardHeader className="bg-gray-50 border-b border-gray-200">
            <CardTitle className="text-lg font-bold text-gray-900">
              ...
              <InfoTooltip content="Comparing current CPI to previous month and Fed target shows inflation momentum. If CPI is above Fed's 2% target, expect hawkish policy (bad for stocks). If below target, expect dovish policy (good for growth stocks)." />
            </CardTitle>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <p className="text-sm text-gray-600 mb-2">
                  Current CPI (YoY)
                  <InfoTooltip content="Year-over-Year CPI shows how much prices have risen in the past 12 months. Above 3% is considered elevated inflation. For options: high CPI = sell call spreads on growth, buy put protection. Low CPI = bullish strategies on tech/growth." />
                </p>
              ...
              <div className="text-center border-l border-r border-gray-200">
                <p className="text-sm text-gray-600 mb-2">
                  Previous Month
                  <InfoTooltip content="Comparing to previous month shows short-term inflation momentum. Month-over-month increases signal accelerating inflation - consider defensive options strategies." />
                </p>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600 mb-2">
                  Fed Target
                  <InfoTooltip content="The Fed targets 2% inflation. Distance from target indicates likelihood of rate changes. Far above = rate hikes coming (bearish). Near or below = potential rate cuts (bullish for stocks)." />
                </p>
