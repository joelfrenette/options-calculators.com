...
import { CheckCircle2, XCircle, AlertTriangle, RefreshCw, Download, TrendingUp, Activity, Shield, Database } from 'lucide-react'
...
export function CcpiAuditAdmin() {
  ...
  const fetchAudit = async () => {
    setLoading(true)
    try {
      const [ccpiRes, dataSourceRes] = await Promise.all([
        fetch("/api/ccpi"),
  ...
  const buildAuditStructure = (ccpi: any, dataSources: any): any => {
    ...
    return {
      ccpi: {
        ...
        executiveSummary: `The Comprehensive Crash Prediction Index (CCPI) aggregates risk across four critical market dimensions. Each pillar contributes a weighted score (0-100), where higher scores indicate elevated crash risk. The final CCPI score ranges from 0 (low risk) to 100 (extreme crash risk).`,
      ...
      canaries: {
        total: ccpi.totalIndicators,
        active: ccpi.activeCanaries,
        formula: "Count of indicators breaching medium or high risk thresholds",
        executiveSummary: `Canary signals are binary warnings triggered when individual indicators cross predefined thresholds. ${ccpi.activeCanaries} of ${ccpi.totalIndicators} indicators are currently flashing warning signals.`,
        severityLevels: {
  ...
  const validateCCPI = (ccpi: any): string => {
    ...
    const calculated = Math.round(momentum * 0.35 + riskAppetite * 0.30 + valuation * 0.15 + macro * 0.20)
    const reported = ccpi.baseCCPI || ccpi.ccpi
    
    if (Math.abs(calculated - reported) <= 2) {
      return `✅ VALID: Calculated CCPI (${calculated}) matches reported value (${reported})`
    } else {
      return `⚠️ DISCREPANCY: Calculated (${calculated}) vs Reported (${reported}) - difference of ${Math.abs(calculated - reported)} points`
    }
  }
  ...
  const buildMomentumPillar = (ccpi: any, dataSources: any): PillarAudit => {
    return {
      ...
      calculation: "16 indicators with explicit weights: NVIDIA (6%), SOX (6%), QQQ Daily Return (8%), QQQ Consecutive Down (5%), QQQ Below SMA20 (5%), QQQ Below SMA50 (7%), QQQ Below SMA200 (10%), QQQ Bollinger (6%), VIX (9%), VXN (7%), RVX (5%), VIX Term (6%), ATR (5%), LTV (5%), Bullish % (5%), Yield Curve (5%)",
      executiveSummary: "Momentum pillar captures price action deterioration, technical breakdown, and volatility spikes. Heavy weighting on critical support levels (SMA50/200) and fear gauges (VIX/VXN). Scores rise dramatically when QQQ breaks key moving averages or volatility explodes above panic thresholds.",
      ...
      indicators: [
        {
          ...
          executiveSummary: "NVIDIA acts as leading indicator for AI/tech sentiment. Rapid drops signal sector rotation or bubble concerns.",
        ...
        },
        {
          ...
          executiveSummary: "Semiconductor index tracks hardware backbone of AI economy. Chip crashes often precede broader tech selloffs.",
        ...
        },
        {
          ...
          executiveSummary: "Single-day crashes are the strongest short-term crash predictor. Down days are weighted 5× more than up days to capture asymmetric risk.",
        ...
        },
        {
          ...
          executiveSummary: "20-day moving average is critical short-term support. Breaches signal momentum loss and potential correction.",
          currentValue: ccpi.indicators.qqqBelowSMA20 ? `YES (${ccpi.indicators.qqqSMA20Proximity.toFixed(0)}% proximity)` : "NO",
          ranges: {
        ...
        },
        {
          ...
          executiveSummary: "50-day moving average marks intermediate trend health. Breaches often precede deeper corrections.",
          currentValue: ccpi.indicators.qqqBelowSMA50 ? `YES (${ccpi.indicators.qqqSMA50Proximity.toFixed(0)}% proximity)` : "NO",
          ranges: {
            safe: "Above SMA50",
        ...
        },
        {
          ...
          executiveSummary: "200-day moving average is the ultimate bull/bear line. Breaches signal potential bear market.",
          currentValue: ccpi.indicators.qqqBelowSMA200 ? `YES (${ccpi.indicators.qqqSMA200Proximity.toFixed(0)}% proximity)` : "NO",
          ranges: {
        ...
        },
        {
          ...
          executiveSummary: "Bollinger bands mark statistical extremes. Breaches indicate oversold conditions or accelerating declines.",
          currentValue: ccpi.indicators.qqqBelowBollinger ? `YES - OVERSOLD (${ccpi.indicators.qqqBollingerProximity.toFixed(0)}% proximity)` : "NO",
          ranges: {
            safe: "Within bands",
        ...
        },
        {
          ...
          executiveSummary: "VIX measures market fear through options prices. Spikes above 25 indicate elevated stress; above 35 signals panic.",
        ...
        },
        {
          ...
          executiveSummary: "VXN specifically tracks tech sector fear. More sensitive to AI/growth stock panic than broad market VIX.",
        ...
        },
        {
          ...
          executiveSummary: "RVX tracks small-cap stress. Often leads broader market volatility as small caps are more sensitive to economic changes.",
        ...
        },
        {
          ...
          executiveSummary: "Term structure shows market's fear timeline. Inversion (ratio < 1.0) means immediate fear exceeds future expectations - classic crash signal.",
        ...
        },
        {
          ...
          executiveSummary: "ATR measures actual price volatility. Rising ATR indicates unstable, whipsaw markets prone to crashes.",
        ...
        },
        {
          ...
          executiveSummary: "LTV captures persistent instability. High LTV means volatility is structural, not transient.",
        ...
        },
        {
          ...
          executiveSummary: "Measures market participation. Extremes (>70% or <30%) indicate overbought/oversold conditions ripe for reversals.",
        ...
        },
        {
          ...
          executiveSummary: "Inverted yield curve (negative spread) has preceded every recession since 1950. Market prices in future economic weakness.",
  ...
  const buildRiskAppetitePillar = (ccpi: any, dataSources: any): PillarAudit => {
    return {
      ...
      calculation: "8 indicators: Put/Call (18%), Fear & Greed (15%), AAII Bullish (16%), Short Interest (13%), ATR (10%), LTV (10%), Bullish % (10%), Yield Curve (8%)",
      executiveSummary: "Risk appetite pillar detects euphoria (complacency) and panic (capitulation) through sentiment and positioning indicators. Low put/call ratios and high bullish sentiment signal dangerous complacency, while extreme fear can be contrarian opportunity.",
      ...
      indicators: [
        {
          ...
          executiveSummary: "Measures market hedging behavior. Ratios below 0.7 signal complacency (too few hedges), above 1.3 signals panic.",
        ...
        },
        {
          ...
          formula: "Composite Sentiment = 7 indicators (VIX, momentum, breadth, safe haven, junk bonds, market momentum, options)",
          executiveSummary: "CNN's aggregate sentiment index. Scores above 75 indicate greed/euphoria; below 25 indicates fear/panic.",
        ...
        },
        {
          ...
          executiveSummary: "Retail investor sentiment survey. Values above 50% indicate excessive optimism; sustained highs precede corrections.",
        ...
        },
        {
          ...
          executiveSummary: "Measures bearish bets on S&P 500. Values below 2% signal complacency; very high values can trigger short squeezes.",
        ...
        },
        {
          ...
          executiveSummary: "High ATR indicates nervous, unstable markets with large intraday swings - precursor to crashes.",
          currentValue: ccpi.indicators.atr.toFixed(1),
          ranges: {
            safe: "Below 30",
            warning: "30-40",
        ...
        },
        {
          ...
          executiveSummary: "Extreme readings indicate overbought (>70%) or oversold (<30%) conditions prone to sharp reversals.",
          currentValue: `${ccpi.indicators.bullishPercent}%`,
          ranges: {
            safe: "40-60%",
        ...
        },
        {
          ...
          executiveSummary: "Inverted curve signals loss of confidence in near-term economy, often preceding recessions and market crashes.",
  ...
  const buildValuationPillar = (ccpi: any, dataSources: any): PillarAudit => {
    return {
      ...
      calculation: "7 indicators: S&P P/E (18%), S&P P/S (12%), Buffett Indicator (16%), QQQ P/E (16%), Mag7 Concentration (15%), Shiller CAPE (13%), Equity Risk Premium (10%)",
      executiveSummary: "Valuation pillar identifies bubble conditions and structural fragility. High P/E ratios, extreme concentration in Mag7, and negative equity risk premiums signal overvalued markets vulnerable to sharp corrections.",
      ...
      indicators: [
        {
          ...
          executiveSummary: "Forward P/E above 22 indicates expensive market; above 25 signals bubble risk. Historical average is ~16-18.",
        ...
        },
        {
          ...
          executiveSummary: "P/S above 2.5 indicates expensive market; above 3.0 signals bubble conditions. Less manipulable than P/E.",
        ...
        },
        {
          ...
          executiveSummary: "Warren Buffett's favorite metric. Above 120% is fairly valued; above 150% is overvalued; above 200% is bubble territory.",
        ...
        },
        {
          ...
          executiveSummary: "QQQ P/E above 30 indicates AI/tech bubble; above 40 signals extreme speculation. More sensitive than S&P 500.",
        ...
        },
        {
          ...
          formula: "Top-Heavy Risk = (AAPL + MSFT + GOOGL + AMZN + NVDA + META + TSLA Market Cap) / Total QQQ Market Cap × 100",
          executiveSummary: "Extreme concentration amplifies crash risk. If Mag7 falls, entire index collapses. Above 60% is dangerous top-heaviness.",
        ...
        },
        {
          ...
          executiveSummary: "CAPE above 30 has historically preceded major market declines. Smooths earnings volatility for long-term valuation view.",
        ...
        },
        {
          ...
          executiveSummary: "Negative or near-zero premiums mean bonds are more attractive than stocks. Below 2% signals stocks are overpriced relative to risk-free rates.",
  ...
  const buildMacroPillar = (ccpi: any, dataSources: any): PillarAudit => {
    return {
      ...
      calculation: "7 indicators: TED Spread (15%), DXY Dollar Index (14%), ISM PMI (18%), Fed Funds Rate (17%), Fed Reverse Repo (13%), Junk Bond Spread (12%), US Debt-to-GDP (11%)",
      executiveSummary: "Macro pillar captures systemic economic and financial conditions. Banking stress (TED spread), policy tightness (Fed funds), and credit stress (junk spreads) signal macro headwinds that can trigger crashes.",
      ...
      indicators: [
        {
          ...
          executiveSummary: "TED spread above 0.5% signals banking sector stress; above 1.0% indicates credit crisis. 2008 crisis saw TED > 4%.",
        ...
        },
        {
          ...
          executiveSummary: "Strong dollar (>110) hurts tech earnings from overseas and tightens global financial conditions. Dollar rallies often precede crashes.",
        ...
        },
        {
          ...
          executiveSummary: "PMI below 50 indicates manufacturing contraction; below 45 signals recession risk. Leading indicator for GDP.",
        ...
        },
        {
          ...
          executiveSummary: "Rates above 5% are restrictive and slow economy. Aggressive rate hikes have triggered past recessions and crashes.",
        ...
        },
        {
          ...
          executiveSummary: "High RRP (>$1T) means tight liquidity. Money market funds choosing Fed over lending to markets reduces available capital.",
        ...
        },
        {
          ...
          executiveSummary: "Spread above 6% signals credit stress; above 8% indicates corporate distress. Widens dramatically before recessions.",
        ...
        },
        {
          ...
          executiveSummary: "Debt above 120% raises sovereign risk concerns; above 130% approaches fiscal crisis. Limits government crisis response capacity.",
...
Score: ${auditData.ccpi.score}/100
...
${auditData.pillars.map((pillar: PillarAudit) => `
## ${pillar.name}
...
${pillar.indicators.map((ind: IndicatorDetail, idx: number) => `
${idx + 1}. **${ind.name}**
   Formula: ${ind.formula}
...
`
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between bg-white rounded-lg p-6 border">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Full formulas, thresholds, data sources, and validation for all {auditData.ccpi.score} indicators across 4 pillars
          </p>
        </div>
        ...
        <CardContent className="space-y-4">
          <div className="bg-white p-6 rounded-lg border border-blue-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-4xl font-bold text-blue-600">{auditData.ccpi.score}/100</div>
            </div>
      ...
      {/* Section 2: Canary Warning System */}
      <Card className="bg-gradient-to-br from-yellow-50 to-orange-50 border-yellow-200">
        <CardHeader>
          <CardTitle className="text-2xl flex items-center gap-2">
            <AlertTriangle className="h-6 w-6 text-yellow-600" />
            2. Canary Warning System
          </CardTitle>
      ...
      {/* Section 3: Four Pillars with Indicators */}
      <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
        <CardHeader>
          <CardTitle className="text-2xl flex items-center gap-2">
            <Activity className="h-6 w-6 text-purple-600" />
            3. Four Pillars - Detailed Breakdown
          </CardTitle>
        ...
        <CardContent>
          <Accordion type="single" collapsible className="space-y-4">
            {auditData.pillars.map((pillar: PillarAudit, pillarIdx: number) => (
              <AccordionItem key={pillarIdx} value={`pillar-${pillarIdx}`} className="border rounded-lg overflow-hidden bg-white">
                <AccordionTrigger className="px-6 py-4 hover:bg-gray-50">
                  <div className="flex items-center justify-between w-full pr-4">
                    <div className="text-left">
                      <h3 className="font-bold text-lg">{pillar.name}</h3>
                      <p className="text-sm text-gray-600">Weight: {pillar.weight}% | {pillar.indicators.length} indicators</p>
                    </div>
                    ...
                    <div>
                      ...
                      <Accordion type="single" collapsible className="space-y-3">
                        {pillar.indicators.map((indicator: IndicatorDetail, indIdx: number) => (
                          <AccordionItem key={indIdx} value={`indicator-${pillarIdx}-${indIdx}`} className="border rounded-lg">
                              ...
                              <div className="space-y-4">
                                ...
                                <div>
                                  ...
                                  <div className="bg-gray-50 p-3 rounded space-y-2">
                                    ...
                                    <div className="text-sm">
                                      <span className="font-semibold">Current:</span> {indicator.dataSources.currentSource} {getStatusBadge(indicator.dataSources.status)}
                                    </div>
                                    <div className="text-sm">
                                ...
                                <div>
                                  ...
                                  <div className="space-y-1">
                                    <div className="p-2 bg-yellow-50 border border-yellow-200 rounded text-sm">
                                      <span className="font-semibold">🟡 Medium Risk:</span> {indicator.canaryThresholds.medium}
                                    </div>
                                    <div className="p-2 bg-red-50 border border-red-200 rounded text-sm">
                                      <span className="font-semibold">🔴 High Risk:</span> {indicator.canaryThresholds.high}
                                    </div>
                                  </div>
                                </div>
                              </div>
