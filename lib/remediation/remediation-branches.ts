/**
 * The remediation branches — one function per classified failure mode, each
 * keyed off a detail string app/api/admin/run-health-checks/route.ts can
 * actually emit. Split from lib/remediation.ts (P6-13); see that file's header
 * for the input contract and the full detail-string list.
 */

import type { HealthResult, DiagnoseContext, Remediation } from "./remediation-types.ts"
import { VERCEL_ENV, VERCEL_PROTECTION, VERCEL_BYPASS } from "./remediation-providers.ts"
import {
  routeFile,
  upstreamMessage,
  keysForRoute,
  ...
  nameList,
  promptHeader,
} from "./remediation-helpers.ts"

// ------------------------------------------------------------------ branches

export function healthy(result: HealthResult): Remediation {
...
export function skipped(result: HealthResult): Remediation {
  return {
    owner: "owner",
    confidence: "certain",
...
export function killSwitch(result: HealthResult, detail: string, ctx?: DiagnoseContext): Remediation {
...
export function missingKey(result: HealthResult, detail: string, ctx?: DiagnoseContext): Remediation {
...
export function sessionExpired(result: HealthResult, viaBlocked: boolean): Remediation {
  return {
    owner: "owner",
    confidence: "certain",
...
export function planOrPermission(result: HealthResult, code: number, detail: string, ctx?: DiagnoseContext): Remediation {
...
export function gone(result: HealthResult, detail: string, ctx?: DiagnoseContext): Remediation {
  const keys = keysForRoute(result, ctx)
  const msg = upstreamMessage(detail)
  return {
    owner: "owner",
...
export function rateLimited(result: HealthResult, detail: string, ctx?: DiagnoseContext): Remediation {
  const keys = keysForRoute(result, ctx)
  const msg = upstreamMessage(detail)
  return {
    owner: "claude",
...
export function serverError(result: HealthResult, code: number, detail: string, ctx?: DiagnoseContext): Remediation {
  const keys = keysForRoute(result, ctx)
  const msg = upstreamMessage(detail)
...
export function notFound(result: HealthResult, detail: string): Remediation {
  const msg = upstreamMessage(detail)
  return {
    owner: "claude",
    confidence: "likely",
...
export function badRequest(result: HealthResult, code: number, detail: string): Remediation {
  const msg = upstreamMessage(detail)
  return {
    owner: "claude",
    confidence: "likely",
...
export function otherClientError(result: HealthResult, code: number, detail: string): Remediation {
  const msg = upstreamMessage(detail)
  return {
    owner: "claude",
    confidence: "likely",
...
export function errorBody(result: HealthResult, detail: string): Remediation {
...
export function contractDrift(result: HealthResult): Remediation {
...
export function notJson(result: HealthResult, detail: string): Remediation {
...
export function timedOut(result: HealthResult): Remediation {
  return {
    owner: "claude",
    confidence: "certain",
...
export function overBudget(result: HealthResult): Remediation {
  return {
    owner: "claude",
    confidence: "certain",
...
export function threw(result: HealthResult, detail: string): Remediation {
 ...
 */
export function aliasMismatch(result: HealthResult, ctx?: DiagnoseContext): Remediation | null {
...
export function unknown(result: HealthResult, detail: string): Remediation {
  return {
    owner: "claude",
    confidence: "likely",
