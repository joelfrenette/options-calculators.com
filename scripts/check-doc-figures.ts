...
const BASELINES = {
  ...
  // → 1195 (4 model-price-coverage) → 1198 (3 billing-class) → 1197 (OpenAI removed) → 1196 (xAI removed) → 1197 (orphan omission guard) → 1198 (AI call-site floor) → 1199 (JSON-response floor), 2026-08-30.
