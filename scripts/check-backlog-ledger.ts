 ...
 */
const EXPECTED_LEDGER_ROWS = 233
const EXPECTED_OPEN = 38
const EXPECTED_FIXED = 186
const EXPECTED_WONTFIX = 8
const EXPECTED_VERIFIED_OK = 1

/**
 * IDs reachable from a table's first cell. The remainder of the ledger (233 - 223)
