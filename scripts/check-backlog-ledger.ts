 ...
 */
const EXPECTED_LEDGER_ROWS = 218
const EXPECTED_OPEN = 40
const EXPECTED_FIXED = 170
const EXPECTED_WONTFIX = 8
const EXPECTED_VERIFIED_OK = 0

/**
 * IDs reachable from a table's first cell. The remainder of the ledger (218 - 208)
