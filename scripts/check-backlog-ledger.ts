 ...
 */
const EXPECTED_LEDGER_ROWS = 235
const EXPECTED_OPEN = 39
const EXPECTED_FIXED = 187
const EXPECTED_WONTFIX = 8
const EXPECTED_VERIFIED_OK = 1

/**
 * IDs reachable from a table's first cell. The remainder of the ledger (235 - 225)
