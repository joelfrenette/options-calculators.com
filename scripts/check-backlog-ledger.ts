 ...
 */
const EXPECTED_LEDGER_ROWS = 216
const EXPECTED_OPEN = 41
const EXPECTED_FIXED = 168
const EXPECTED_WONTFIX = 7
const EXPECTED_VERIFIED_OK = 0

/**
 * IDs reachable from a table's first cell. The remainder of the ledger (216 - 206)
