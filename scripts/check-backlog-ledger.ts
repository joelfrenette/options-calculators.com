 ...
 */
const EXPECTED_LEDGER_ROWS = 250
const EXPECTED_OPEN = 29
const EXPECTED_FIXED = 212
const EXPECTED_WONTFIX = 8
const EXPECTED_VERIFIED_OK = 1

/**
 * IDs reachable from a table's first cell. The remainder of the ledger (250 - 240)
