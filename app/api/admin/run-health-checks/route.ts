...
function contractCoverage() {
  const KNOWN_ROUTES = [
    "/api/admin/api-keys", "/api/admin/api-status", "/api/admin/members", "/api/auth/session", "/api/auth/reset/request", "/api/auth/reset/confirm", "/api/report-email", "/api/report/download",
