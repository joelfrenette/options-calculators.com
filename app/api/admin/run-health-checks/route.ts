...
function contractCoverage() {
  const KNOWN_ROUTES = [
    "/api/admin/api-keys", "/api/admin/api-status", "/api/admin/members", "/api/auth/session", "/api/auth/reset/request", "/api/auth/reset/confirm", "/api/report-email", "/api/report/download", "/api/research-queue", "/api/research-profile",
    ...
    "/api/breadth-backtest", "/api/congress-trades", "/api/cpi-inflation", "/api/cron/breadth", "/api/cron/budget-guard", "/api/cron/ccpi-health", "/api/cron/fred-snapshot", "/api/cron/market-snapshot", "/api/cron/quiver-probe", "/api/cron/research-refresh",
