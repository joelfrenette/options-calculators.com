              ...
              <CardContent>
                  ...
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                      <Card className="bg-green-50 border-green-200">
                        ...
                        <CardContent>
                          <p className="text-3xl font-bold text-green-600">{dataSourceStatus.summary.online || 0}</p>
                          <p className="text-xs text-green-700">of {dataSourceStatus.summary.total || 0} sources</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-yellow-50 border-yellow-200">
                        ...
                        <CardContent>
                          <p className="text-3xl font-bold text-yellow-600">{dataSourceStatus.summary.usingFallback || 0}</p>
                      ...
                      <Card className="bg-red-50 border-red-200">
                        ...
                        <CardContent>
                          <p className="text-3xl font-bold text-red-600">{dataSourceStatus.summary.offline || 0}</p>
                    ...
                    {dataSourceStatus.dataSources && dataSourceStatus.dataSources.length > 0 && (
                      <div className="space-y-4">
                ...
                {!dataSourceStatus && !loading && (
                  <div className="text-center py-8 text-slate-500">
                    ...
                    <p className="text-sm">No data source status available. Click "Check All Data Sources" to analyze.</p>
                  </div>
                )}
              </CardContent>
            </Card>
